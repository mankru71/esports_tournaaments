...
curl -i -Method Post "$BaseUrl/api/auth/register" -ContentType "application/json" -Body "{\"email\":\"$registerEmail\",\"password\":\"$registerPassword\",\"role\":\"captain\",\"nickname\":\"smokeUser\"}"
