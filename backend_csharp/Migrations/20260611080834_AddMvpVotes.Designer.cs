...
namespace EsportsBackend.Migrations
{
    ...
    [Migration("20260611080834_AddMvpVotes")]
    partial class AddMvpVotes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.FantasyRoster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ProPlayerId");

                    b.ToTable("FantasyRosters");
                });

            modelBuilder.Entity("Models.FantasyTeam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Models.MvpVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Models.FantasyRoster", b =>
                {
                    b.HasOne("Models.FantasyTeam", "FantasyTeam")
                        .WithMany("Roster")
                        .HasForeignKey("FantasyTeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Models.TeamPlayer", "ProPlayer")
                        .WithMany()
                        .HasForeignKey("ProPlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FantasyTeam");

                    b.Navigation("ProPlayer");
                });
            ...
            modelBuilder.Entity("Models.MvpVote", b =>
                {
                    b.HasOne("Models.TeamPlayer", "Player")
                        .WithMany()
